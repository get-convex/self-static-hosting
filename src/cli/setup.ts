 ...
 */
function updatePackageJson(config: SetupConfig): boolean {
 ...
 */
function updateEnvLocal(pagesProject: string): void {
 ...
 */
async function setupCloudflarePages(): Promise<string | null> {
  console.log("");
